...
const createCatppuccinTheme = (palette) =>
	createTheme({
		primaryColor: "blue",
		defaultRadius: 0,
		...
		colors: {
			...
			red: [palette.red, palette.maroon, ...Array(8).fill(palette.red)],
			yellow: [palette.yellow, palette.peach, ...Array(8).fill(palette.yellow)],
			gray: [
				palette.text,
				palette.subtext1,
				palette.subtext0,
			...
			Modal: {
				styles: {
					...
					header: {
						...
						borderBottom: `1px solid ${palette.surface1}`,
						borderRadius: 0,
					},
				},
			},
