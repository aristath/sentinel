...
// CheckMicroserviceHealth checks health of the unified microservice
...
// GetMicroserviceHealthURL returns the health check URL for the unified microservice
func (d *MicroserviceDeployer) GetMicroserviceHealthURL(serviceName string) string {
	// Unified service runs on port 9000
