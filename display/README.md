...
- `app/` - Docker Python app that polls the trading API and updates the display
- `bridge/` - Go bridge service that handles communication between components
- `sketch/` - Arduino C++ sketch that controls the LED matrix
...
1. Docker Python app (`display/app/main.py`) runs via Arduino App Framework
...
- `app/main.py` - Docker Python app for LED display (Arduino App Framework)
...
- `bridge/` - Go bridge service for display communication
