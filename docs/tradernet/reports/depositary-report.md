...
| params | encoded_result | int|null | Retrieves the report as a JSON array containing the encoded file in section `file` base64 (Save where a report is requested in the format JSON). Optional parameter.
