          ...
          <div class="sticky top-0 bg-gray-900 z-10 border-b border-gray-700">
            ...
            <div class="flex border-b border-gray-700 px-4">
              <button @click="activeTab = 'trading'"
                      :class="activeTab === 'trading' ? 'border-b-2 border-blue-500 text-blue-400' : 'text-gray-400 hover:text-gray-300'"
                      class="px-4 py-2 text-sm font-medium transition-colors">
                Trading
              </button>
              <button @click="activeTab = 'portfolio'"
                      :class="activeTab === 'portfolio' ? 'border-b-2 border-blue-500 text-blue-400' : 'text-gray-400 hover:text-gray-300'"
                      class="px-4 py-2 text-sm font-medium transition-colors">
                Portfolio
              </button>
              <button @click="activeTab = 'planning'"
                      :class="activeTab === 'planning' ? 'border-b-2 border-blue-500 text-blue-400' : 'text-gray-400 hover:text-gray-300'"
                      class="px-4 py-2 text-sm font-medium transition-colors">
                Planning
              </button>
              <button @click="activeTab = 'display'"
                      :class="activeTab === 'display' ? 'border-b-2 border-blue-500 text-blue-400' : 'text-gray-400 hover:text-gray-300'"
                      class="px-4 py-2 text-sm font-medium transition-colors">
                Display
              </button>
              <button @click="activeTab = 'system'"
                      :class="activeTab === 'system' ? 'border-b-2 border-blue-500 text-blue-400' : 'text-gray-400 hover:text-gray-300'"
                      class="px-4 py-2 text-sm font-medium transition-colors">
                System
              </button>
            </div>
              ...
              <div x-show="activeTab === 'planning'" x-transition class="space-y-6">
                ...
                <div class="bg-gray-800 border border-gray-700 rounded p-4">
                  <div class="flex items-center justify-between mb-3">
                    <h3 class="text-sm font-medium text-gray-400 uppercase tracking-wide">Enhanced Scenario Exploration</h3>
