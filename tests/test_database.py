...
class TestSchemaInitialization:
    ...
    async def test_schema_creates_required_tables(self, temp_db):
        ...
        required_tables = [
            'settings', 'securities', 'positions', 'prices',
            'trades', 'allocation_targets', 'scores', 'cash_balances'
        ]
    ...
    async def test_ml_tables_created(self, temp_db):
        ...
        ml_tables = [
            'ml_training_samples', 'ml_models', 'ml_predictions',
